...
var myaudio = document.getElementById('Audiomusic');

myaudio.addEventListener('ended', function(e) {
  // get the active source and the next video source.
  // I set it so if there's no next, it loops to the first one
  var activesource = document.querySelector("#Audiomusic source.active");
  var nextsource = document.querySelector("#Audiomusic source.active + source") || document.querySelector("#Audiomusic source:first-child");
